        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Aliases = table.Column<string>(type: "TEXT", maxLength: 240, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "INTEGER", nullable: false),
                    UserDisplayName = table.Column<string>(type: "TEXT", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverPath = table.Column<string>(type: "TEXT", maxLength: 260, nullable: true),
                    Description = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SamplePath = table.Column<string>(type: "TEXT", maxLength: 260, nullable: true),
                    FullPath = table.Column<string>(type: "TEXT", maxLength: 260, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_AlbumId_Format",
                table: "Products",
                columns: new[] { "AlbumId", "Format" },
                unique: true);
